...
public class TicTacToe {
    ...
    public void playTicTacToe() {
        ...
        while (Playmore != "n" && Playmore != "N") {
            ...
            if (player1turn == 2) {
                StdOut.println(player1 + " has won! Do you want to play again (y/n)? ");
                Scanner scan1 = new Scanner(System.in);
                Playmore = scan1.nextLine();  //Playmore = StdIn.readChar();
            }
            else {
                StdOut.println(player2 + " has won! Do you want to play again (y/n)? ");
    ...
    public void makeMove() {
        if (player1turn == 1){
            StdOut.println("Make a move " + player1 + " (1-9): ");
            int move = StdIn.readInt();
            board[move-1] = 'X';
            int i = 0;
        }
        else {
            StdOut.println("Make a move " + player2 + " (1-9): ");
            int move = StdIn.readInt();
            board[move-1] = 'O';
            int i = 0;
        }
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("Thanks for playing TicTacToe " + newgame.NrOfGames + " times!");
    }
}